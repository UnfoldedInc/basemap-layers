...
export function parseMapboxStyle(options = {}) {
  ...
  visitLayers(style, layer => {
    ...
    var layerProperties = []
    visitProperties(layer, {paint: true}, property => layerProperties.push(property))

    var deckFeatures = generateDeckFeatures(layerFeatures, layerProperties, globalProperties)
